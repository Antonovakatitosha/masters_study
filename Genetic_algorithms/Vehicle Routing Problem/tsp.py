...
class TravelingSalesmanProblem:
    ...
    def __initData(self):
        ...
        try:
            self.locations = pickle.load(open(os.path.join("../04/Traveling Salesman Problem", self.name + "-loc.pickle"), "rb"))
            self.distances = pickle.load(open(os.path.join("../04/Traveling Salesman Problem", self.name + "-dist.pickle"), "rb"))
    ...
    def __createData(self):
        ...
        with urlopen("https://raw.githubusercontent.com/ryanjoneil/tsplib/master/elib.zib.de/pub/mp-testdata/tsp/tsplib/tsp/gr137.tsp") as f:
            ...
            if not os.path.exists("../04/Traveling Salesman Problem"):
                os.makedirs("../04/Traveling Salesman Problem")
            pickle.dump(self.locations, open(os.path.join("../04/Traveling Salesman Problem", self.name + "-loc.pickle"), "wb"))
            pickle.dump(self.distances, open(os.path.join("../04/Traveling Salesman Problem", self.name + "-dist.pickle"), "wb"))
